...
export function PhoneOffIcon({
  ...
  return (
    ...
    >
      <path
        d="M22 16.92V20C22 20.5304 21.7893 21.0391 21.4142 21.4142C21.0391 21.7893 20.5304 22 20 22C15.5993 21.7524 11.3928 20.0817 7.87999 17.2C4.60999 14.5 2.10999 11 0.359985 7C-0.640015 4.5 0.359985 1.5 2.85999 0.5C3.14999 0.4 3.43999 0.3 3.72999 0.3C4.25999 0.3 4.76999 0.5 5.15999 0.9L8.15999 3.9C8.94999 4.69 8.94999 5.99 8.15999 6.78L6.99999 7.94C6.60999 8.33 6.60999 8.96 6.99999 9.35C8.49999 11.35 10.65 13.5 12.65 15C13.04 15.39 13.67 15.39 14.06 15L15.22 13.84C16.01 13.05 17.31 13.05 18.1 13.84L21.1 16.84C21.5 17.24 21.7 17.74 21.7 18.27C21.7 18.56 21.6 18.85 21.5 19.14C21.4 19.43 21.3 19.72 21.1 20.01C20.9 20.3 20.7 20.59 20.4 20.88C20.1 21.17 19.8 21.46 19.5 21.75"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
